...
class App(ctk.CTk):
    ...
    def _build_header(self):
        ...
        self._theme_var = ctk.StringVar(
            value="dark" if ctk.get_appearance_mode().lower() == "dark" else "light"
        )
        theme_btn = ctk.CTkSegmentedButton(
            ...
            unselected_hover_color=DARK_BD,
            text_color=TEXT,
        )
    ...
    def _update_breadcrumb(self, crumbs: list[tuple[str, callable | None]]):
    ...
    def show_order(self, order_id: int | None = None, order=None):
        if order_id:
